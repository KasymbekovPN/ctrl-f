...
class ResponseImplTest {
	...
	void shouldCheckSuccessResponse() {
		...
		ResponseImpl<TestValue, TestErrorArgs> response = new ResponseImpl<>(expectedValue);
	...
	void shouldCheckFailResponse() {
		...
		ResponseImpl<TestValue, TestErrorArgs> response = new ResponseImpl<>(expectedCode, expectedArgs);
